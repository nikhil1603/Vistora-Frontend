...
const Navbar = () => {
  ...
  return (
    <div className="z-50 sticky top-0 bg-background/50 backdrop-blur">
       <div className="container mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between">
           <h1 className="text-lg font-bold ">Vistora</h1>
           <ul className="flex justify-center items-center space-x-6">
               ...
               <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full">{ totalItem ?? 0}</span>
               </li>
